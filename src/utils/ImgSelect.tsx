...
const ImgSelect = ({selectTab, data}:InforBlockProps) => {
   switch(selectTab) {
      case  "overview":
        return <FigureContainer><ImageContent style='min-w-30 px-20 md:p-0 md:max-w-75 xl:max-w-125 '  url={data.images.planet}/></FigureContainer>
      break  
      case  "structure":
        return <FigureContainer><ImageContent style='min-w-30 px-20 md:p-0 md:max-w-75 xl:max-w-125' url={data.images.internal}/></FigureContainer>
      break  
      case  "geology":
        return <FigureContainer style='relative'>
             <ImageContent style='min-w-30 px-20 md:p-0 md:max-w-75 xl:max-w-125' url={data.images.planet}/>
